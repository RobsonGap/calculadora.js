...
function chart(principal, interest, monthly, payments) {
    ...
    g.fillText // Rotula em verde

    // Faz o laço novamente, como acima, mas representa o saldo devedor como uma linha
    // preta e grossa no gráfico
    var bal = principal;
    g.beginPath();
